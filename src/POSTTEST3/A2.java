...
public class A2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ComboBox", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        Cmb2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        Cmb2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2016", "2015", "2014", "2013" }));

        Cmb4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        Cmb1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        Cmb1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Teknik Informatika", "Ilmu Komputer" }));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel4.setText("Daerah Asal");

        Cmb3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        Cmb3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kalimantan Timur", "Kalimantan Selatan" }));
        Cmb3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                Cmb3MouseReleased(evt);
            }
        });
        ...
        Cmb3.addKeyListener(new java.awt.event.KeyAdapter() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Prodi = Cmb1.getSelectedItem().toString();
        Ang = Cmb2.getSelectedItem().toString();
        DA = Cmb3.getSelectedItem().toString();
        KA = Cmb4.getSelectedItem().toString();
        
        Area.setText("Prodi : "+Prodi+"\nAngkatan : "+Ang+"\nDaerah Asal : "+DA+"\nKota Asal : "+KA);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        modelcombo1.addElement("Tenggarong");
        Cmb4.setModel(modelcombo1);
    ...
    private void Cmb3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Cmb3KeyReleased
        
    }//GEN-LAST:event_Cmb3KeyReleased

    private void Cmb3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Cmb3KeyPressed
        
    }//GEN-LAST:event_Cmb3KeyPressed

    private void Cmb3MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Cmb3MouseReleased
        
    }//GEN-LAST:event_Cmb3MouseReleased
    ...
    private void Cmb3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cmb3ActionPerformed
        ...
        if(DA.equals("Kalimantan Timur"))
        {
            Cmb4.setModel(modelcombo1);
        }
        
        DefaultComboBoxModel modelcombo2 = new DefaultComboBoxModel();
        modelcombo2.addElement("Banjarmasin");
        if (DA.equals("Kalimantan Selatan"))
        {
            Cmb4.setModel(modelcombo2);
        }
