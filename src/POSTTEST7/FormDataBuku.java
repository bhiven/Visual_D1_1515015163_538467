...
public class FormDataBuku extends javax.swing.JFrame {
    ...
    private Connection con = Koneksi.Buka_Koneksi();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(TxtHarga, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
        ...
        CmbCari.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(BSimpan, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                                .addGap(2, 2, 2)
                                .addComponent(BUbah, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(CmbCari, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BSimpan, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BUbah, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BHapus, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void TxtCariCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_TxtCariCaretUpdate
        if(CmbCari.getSelectedItem()=="Judul"){
            InitTable(); 
            CariJudul(); 
        }
        else if(CmbCari.getSelectedItem()=="Penulis"){
            InitTable(); 
            CariPenulis(); 
        }
...
private void InitTable(){
    ...
    private void CariPenulis(){
        try{
            String sql = "Select * from Buku where penulis like '%" + TxtCari.getText() + "%'"; 
            stt=con.createStatement();                                                          
            rss=stt.executeQuery(sql);
            while(rss.next()){
                Object[] o = new Object[3];
